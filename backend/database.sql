...
-- 13. Insert sample users (optional - remove if not needed)
INSERT INTO users (username, full_name, email, password_hash, role, created_at, updated_at)
VALUES 
    ('john_doe', 'John Doe', 'john.doe@company.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj6hsxq8Kfq2', 'user', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('jane_smith', 'Jane Smith', 'jane.smith@company.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj6hsxq8Kfq2', 'user', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
ON DUPLICATE KEY UPDATE username = username;
